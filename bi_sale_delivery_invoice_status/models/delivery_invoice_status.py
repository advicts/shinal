...
class inherit_sale(models.Model):
	...
	advicts_amount_due = fields.Float(string="amount due")
	advicts_amount_paid = fields.Float(string="paid amount")
			...
			for sale in sale_order:
				if sale.name == invoice.invoice_origin:
					if invoice.payment_state in ("paid", "partial"):
						...
						sale.write({
									"advicts_amount_due": invoice.amount_residual,
									"advicts_amount_paid": sale.amount_total-invoice.amount_residual,
								})
